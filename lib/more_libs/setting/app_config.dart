...
class AppConfig extends ChangeNotifier {
  ...
  Map<String, String> _getDefaultTranslations(String code) {
    ...
    return {
      ...
      'saved_locally': 'ဒေသန္တရစ်မှာသိမ်းပြီးပါပြီ — အွန်လိုင်းဖြစ်လျှင် ပြန်နှိမ့်ပါမယ်',
      'save_failed': 'သိမ်းဆည်းလို့ မရပါ — ထပ်စမ်းကြည့်ပါ',
      'sync_failed': 'အချို့အကြောင်းအရာများ ပြန်နှိမ့်လို့ မရပါ — နောက်မှ ထပ်စမ်းပါ',
